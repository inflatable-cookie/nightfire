...
describe("nightfire value-updates", () => {
	...
	it("changes a single block type without product-specific transforms", () => {
		const result = changeSingleBlockType("example:content/article", null, "custom", (type) => type);
