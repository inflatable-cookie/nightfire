...
cleanup. A block renderer still adds no token and takes no dependency on one.
...
Market/Silo Chatterbox consultation of 2026-09-18, and it is recorded in full in
[g01.010](../roadmaps/g01/010-core-schema-identity.md).
