...
3. Sanitize the rendered embed markup, and prove it with a component test carrying a hostile embed
   value.
4. Prove the declaration holds, and prove the renderer stays editor-free.
