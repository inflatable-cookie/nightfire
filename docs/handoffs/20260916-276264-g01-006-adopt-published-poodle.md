...
title: "g01.006 — Adopt published Poodle 0.4.2"
...
roadmap: docs/roadmaps/g01/006-adopt-published-poodle-0-4-2.md
...
- **Current task:** `docs/roadmaps/g01/006-adopt-published-poodle-0-4-2.md` (`g01.006`).
...
- **In scope:** the pin bump from `0.2.2` to `0.4.2` and the call-site
